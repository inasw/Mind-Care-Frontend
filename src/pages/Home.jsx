  ...
  return (
    <div className={style.home}>
      ...
      <div className={style.testimonials}>
        <h1>Testimonials</h1>
        <div className={style.testp}>
        <img src={pen} alt="" />
          <div className={style.conunsel}><p>
          "Our experience with the MindCare web app has been exceptional. As the university counseling office, we have seen the positive impact this platform has had on our students' mental well-being. The platform's user-friendly interface and comprehensive features make it an invaluable resource for our students seeking mental health support."
          </p>
          <span>University Counseling Office Mr. Lemma</span>
          </div>
